...
def mock_llm_response():
    ...
    return (
        "Hola mundo. Este es un texto de ejemplo para aprender español.",
        {"text": "Hola mundo.", "content": "Hola mundo. Este es un texto de ejemplo."},
    )
...
def create_test_lexeme(db, profile_id, lemma="hola"):
