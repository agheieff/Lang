Please generate a text in Chinese for the comprehensible input training.
...
{topic_line}Try to make the text fit the users style and topic preferences: {preferences}
