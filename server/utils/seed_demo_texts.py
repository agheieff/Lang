...
def seed_english_demo(db: Session) -> None:
    ...
    content = text.content
    words_data = [
        ("Hello!", "hello", "INTJ", "¡Hola!", 0, 6, "/həˈloʊ/"),
        ("Welcome", "welcome", "INTJ", "Bienvenido", 7, 14, "/ˈwɛlkəm/"),
        ("to", "to", "ADP", "a", 15, 17, "/tu/"),
        ("your", "your", "DET", "tu", 18, 22, "/jɔr/"),
        ("reading", "reading", "NOUN", "lectura", 23, 30, "/ˈridɪŋ/"),
        ("practice.", "practice", "NOUN", "práctica", 31, 40, "/ˈpræktɪs/"),
        ("This", "this", "DET", "Este", 41, 45, "/ðɪs/"),
        ("is", "be", "AUX", "es", 46, 48, "/ɪz/"),
        ("a", "a", "DET", "un", 49, 50, "/ə/"),
        ("simple", "simple", "ADJ", "simple", 51, 57, "/ˈsɪmpəl/"),
        ("demo", "demo", "NOUN", "demostración", 58, 62, "/ˈdɛmoʊ/"),
        ("text", "text", "NOUN", "texto", 63, 67, "/tɛkst/"),
        ("to", "to", "ADP", "para", 68, 70, "/tu/"),
        ("get", "get", "VERB", "comenzar", 71, 74, "/ɡɛt/"),
        ("you", "you", "PRON", "te", 75, 78, "/ju/"),
        ("started.", "start", "VERB", "empezado", 79, 87, "/ˈstartɪd/"),
        ("The", "the", "DET", "El", 88, 91, "/ðə/"),
        ("full", "full", "ADJ", "completo", 92, 96, "/fʊl/"),
        ("text", "text", "NOUN", "texto", 97, 101, "/tɛkst/"),
        ("generation", "generation", "NOUN", "generación", 102, 112, "/ˌdʒɛnəˈreɪʃən/"),
        ("system", "system", "NOUN", "sistema", 113, 119, "/ˈsɪstəm/"),
        ("will", "will", "AUX", "estará", 120, 124, "/wɪl/"),
        ("be", "be", "AUX", "será", 125, 127, "/bi/"),
        ("available", "available", "ADJ", "disponible", 128, 137, "/əˈveɪləbəl/"),
        ("soon.", "soon", "ADV", "pronto", 138, 143, "/sun/"),
    ]

    for surface, lemma, pos, translation, start, end, ipa in words_data:
        word = ReadingWordGloss(
            text_id=text.id,
            target_lang="es",
            lang="en",
            ...
            lemma=lemma,
            pos=pos,
            pinyin=ipa,  # Using pinyin field for IPA pronunciation
            translation=translation,
            lemma_translation=translation,
            span_start=start,
            span_end=end,
